...
<html>
    <head>
        <title>Alt-Tap Infinite Mode</title>
...
<script>
    ...
    function starten(){
        ...
        $('#startalius').click(function(){
          var tijdCheck;
              function resetTijd(){
                clearTimeout(tijdCheck);
                tijdCheck = setTimeout(youbedead,timetodiebruh*1000);
              }
            $('#startalius, #carta1, #carta2, #middon').click(resetTijd);
            resetTijd();
        });
    ...
    <div id='userkies'>
        ...
        <form id='keusnaam' method='POST'>
            ...
            <input id=submitkeus type=submit value='Kies Naam'>
        </form>
    </div>
    ...
    <div id='berichtus'></div>
       ...
       Oneindig tijds limiet PAS OP! als je geen keuze maakt binnen 1 seconden ben je game over.<br>
